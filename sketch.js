...
function ticket() {
  ...
  if(mouseX>272&&mouseX<303&&mouseY<437&&mouseY>406){
     ...
     text("당신에게 세상이", 120, 355);
     text("친밀하고 충만하게 다가오는지,", 120, 375);
     text("아니면 약간은 낯설거나", 120, 395);
     text("거리감이 느껴지는지에 따라 말이지요.", 120, 405);
     text("주사위의 숫자가 작아질수록 당신은", 120, 425);
     text("세상에 담담히 자리잡은 돌벽과 같을 것이고,", 120, 445);
