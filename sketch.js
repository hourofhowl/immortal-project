...
function ticket() {
  ...
  if (mouseX > 272 && mouseX < 303 && mouseY < 437 && mouseY > 406) {
    ...
    textSize(12);
    textFont(font2);
    text("당신이 세상에 대해 느끼는 거리감에 따라\n안 숫자가 달라집니다.\n당신에게 세상이\n친밀하고 충만하게 다가오는지,\n아니면 약간은 낯설거나\n거리감이 느껴지는지에 따라 말이지요.\n주사위의 숫자가 작아질수록 당신은\n세상에 담담히 자리잡은 돌벽과 같을 것이고,\n주사위의 숫자가 커질수록\n세상을 기꺼이\n끌어안으려는 품과 같은 사람일 것입니다.", 120, 315);
    ...
    textFont(font2);
    if (countA_1 >= maxQ1) {
      text("당신의 손끝으로 느낀\n촉각 기억에 따라\n이 모양이 결정됩니다.\n몽글몽글하게 피어오르는\n구름의 모양처럼,\n당신은 세계를 부드럽고 말랑하게\n받아들이는 사람 같습니다.", 1155, 250);
    } else if (countB_1 >= maxQ1) {
      text("당신의 손끝으로 느낀\n촉각 기억에 따라\n이 모양이 결정됩니다.\n잔뜩 얽힌 덩굴의 모양처럼,\n당신은 세계와 밀접한 관계를 유지하며\n얼기설기 뻗어나가고 있는 사람 같습니다.", 1155, 250);
    } else if (countC_1 >= maxQ1) {
      text("당신의 손끝으로 느낀\n촉각 기억에 따라\n이 모양이 결정됩니다.\n꼿꼿하게 솟아난 선인장의 모양처럼,\n당신은 강인함과 차분함을 지니고\n하늘을 향해 굳건히 서 있는 사람 같습니다.", 1155, 250);
    } else if (countD_1 >= maxQ1) {
      text("당신의 손끝으로 느낀\n촉각 기억에 따라\n이 모양이 결정됩니다.\n바람에 살랑이는 꽃잎의 움직임처럼,\n당신은 유연하고 상쾌한 몸짓으로\n세계를 받아들이는 사람 같습니다.", 1155, 250);
    } else if (countE_1 >= maxQ1) {
      text("당신의 손끝으로 느낀\n촉각 기억에 따라\n이 모양이 결정됩니다.\n나지막한 이끼의 분포처럼,\n당신은 따스한 온도를 지니고서\n세계에 조용한 생명력을\n불어넣는 사람 같습니다.", 1155, 250);
    }
    ...
    textSize(12);
    textFont(font2);
    text("내면 깊숙한 곳을 감싸고 있는 당신의 감정 상태는 어떠한가요?\n그 미묘한 감정들이, 당신이 사랑하는 계절의 빛깔과 만나\n티켓의 배경색으로 표현되었을 겁니다.", 480, 485);
    if (countA_2 >= maxQ2) {
      text("당신이 세상에서 비롯되는 갖가지 향기를 어떻게 인지하는가에 따라\n티켓의 질감이 표현될 것입니다.\n반복된 물결로 잘 다듬어진 조약돌처럼,\n당신은 매끈하고 넉살좋게 외부의 향기를 받아들이는 것 같습니다.", 860, 480);
    } else if (countB_2 >= maxQ2) {
      text("당신이 세상에서 비롯되는 갖가지 향기를 어떻게 인지하는가에 따라\n티켓의 질감이 표현될 것입니다.\n당신은 까끌거리는 모래처럼,\n세밀하고 민감하게 외부의 향기를 받아들이는 것 같습니다.", 860, 480);
    } else if (countC_2 >= maxQ2) {
      text("당신이 세상에서 비롯되는 갖가지 향기를 어떻게 인지하는가에 따라\n티켓의 질감이 표현될 것입니다.\n당신은 거칠한 나무처럼\n격한 바람 속에서도 쉽게 흔들리지 않고 묵묵히 한 자리를 지키며,\n외부의 향기를 천천히 그러나 깊이 받아들이는 것 같습니다.", 860, 480);
    } else if (countD_2 >= maxQ2) {
      text("당신이 세상에서 비롯되는 갖가지 향기를 어떻게 인지하는가에 따라\n티켓의 질감이 표현될 것입니다.\n당신은 외부의 향기를,\n흐르는 물결처럼 자연스럽고 풍성하게 받아들이는 겄 같습니다.", 860, 480);
    } else if (countE_2 >= maxQ2) {
      text("당신이 세상에서 비롯되는 갖가지 향기를 어떻게 인지하는가에 따라\n티켓의 질감이 표현될 것입니다.\n당신은 제각기 반짝이는 별들처럼,\n개성넘치고 톡톡 튀는 방식으로\n외부의 향기를 받아들이는 것 같습니다.", 860, 480);
    }
