...
function ticket() {
  ...
  if(mouseX>272&&mouseX<303&&mouseY<437&&mouseY>406){
     ...
     textSize(10);
     textFont(font2);
     text("당신이 세상에 대해 느끼는 거리감에 따라", 100, 315);
     text("주사위 안 숫자가 달라집니다.", 100, 345);
     text("당신에게 세상이 친밀하고 충만하게 다가오는지,", 100, 375);
     text("아니면 약간은 낯설거나 거리감이 느껴지는지에 따라 말이지요.", 100, 405)
     text("주사위의 숫자가 작아질수록", 100, 435);
     text("당신은 세상에 담담히 자리잡은 돌벽과 같을 것이고,", 100, 465);
